      ...
      <div className={styles.left}>
        <div className={styles.row}>
          <table className={styles.table}>
            ...
            <tr>
              <td>
                <span className={styles.id}>12365875845698</span>
              </td>
              <td>
                <span className={styles.name}>Godfrey Kwame Twene</span>
              </td>
              <td>
                <span className={styles.address}>
                  Kwame Street, Accra Ghana
                </span>
              </td>
              <td>
                <span className={styles.total}>GHS79.80</span>
              </td>
            </tr>
          </table>
        </div>
